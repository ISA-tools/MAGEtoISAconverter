...
public class MAGETabObtainTest {
    ...
    public void testMAGETabConvert() {
        ...
        try {
            ...
            ISAConfigurationSet.setConfigPath("/Users/prs/git/Configuration-Files/isaconfig-default_v2011-02-18 copy");
            ...
            assertEquals("Validation was not successful, it should have been :-o", GUIInvokerResult.SUCCESS, result);
